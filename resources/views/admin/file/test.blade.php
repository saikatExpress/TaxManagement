            ...
            <div style="width: 80%; margin-left:auto; margin-right:auto; display:block;">
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Assessment Year</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">TIN No</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">NID No</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Circle & Zone</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Net Wealth</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Net Wealth(previous)</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Accretion in Wealth</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Non Agriculture Property</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Motor Vehicle</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Furniture</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Cash In Hand</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Family Expense</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Payment</div>
                ...
                <div>
                    ...
                    <div style="font-size: 1.4rem; margin-bottom: 10px;">
                        <div style="float: left; width: 25%; color:#000;font-weight:600;">Remarks</div>
