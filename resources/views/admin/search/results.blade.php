                                    ...
                                    <tbody>
                                        @foreach ($results as $key => $pdf)
                                            <tr class="list-item">
                                                ...
                                                <td>{{ $pdf->payment }}</td>
                                                <td>
                                                    <a href="{{ route('pdf.load', ['id' => $pdf->id]) }}"
                                                        class="btn btn-sm btn-primary">
                                                        <i class="fas fa-solid fa-file-pdf"></i>
                                                    </a>
                                                    <a href="{{ route('generate.print', ['id' => $pdf->id]) }}"
                                                        class="btn btn-sm btn-primary">
                                                        <i class="fas fa-solid fa-print"></i>
                                                    </a>
                                                    <a href="{{ route('edit', ['id' => $pdf->id]) }}"
                                                        class="btn btn-sm btn-primary">
                                                    ...
                                                    <button type="button" data-toggle="modal"
                                                        data-name="{{ $pdf->name }}"
                                                        data-assessment_year="{{ $pdf->assessment_year }}"
                                                        data-address={{ $pdf->address }} data-tin_no="{{ $pdf->tin_no }}"
                                                        data-mobile_no="{{ $pdf->mobile_no }}"
                                                        data-nid_no="{{ $pdf->nid_no }}"
                                                        data-source_income="{{ $pdf->source_income }}"
                                                        data-circle_of_zone="{{ $pdf->circle_of_zone }}"
                                                        data-total_income="{{ $pdf->total_income }}"
                                                        data-net_wealth="{{ $pdf->net_wealth }}"
                                                        data-tax_paid="{{ $pdf->tax_paid }}"
                                                        data-previous_net_wealth="{{ $pdf->previous_net_wealth }}"
                                                        data-business_capital="{{ $pdf->business_capital }}"
                                                        data-accretion_in_wealth="{{ $pdf->accretion_in_wealth }}"
                                                        data-non_agriculture_property="{{ $pdf->non_agriculture_property }}"
                                                        data-agriculture_property="{{ $pdf->agriculture_property }}"
                                                        data-investment="{{ $pdf->investment }}"
                                                        data-motor_vehicle="{{ $pdf->motor_vehicle }}"
                                                        data-jewellery="{{ $pdf->jewellery }}"
                                                        data-furniture="{{ $pdf->furniture }}"
                                                        data-electronic_equipment="{{ $pdf->electronic_equipment }}"
                                                        data-other_asset="{{ $pdf->other_asset }}"
                                                        data-cash_in_hand="{{ $pdf->cash_in_hand }}"
                                                        data-liabilities="{{ $pdf->liabilities }}"
                                                        data-family_expense="{{ $pdf->family_expense }}"
                                                        data-source_of_fund="{{ $pdf->source_of_fund }}"
                                                        data-payment="{{ $pdf->payment }}"
                                                        data-register_number="{{ $pdf->register_number }}"
                                                        data-remarks="{{ $pdf->remarks }}"
                                                        data-submission_date={{ $pdf->submission_date }}
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="clientForm" style="width: 100%;" action="{{ route('client.store') }}" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="non_agriculture_property"
                                                    class="form-control">
                                            </div>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-4">
                                <div style="text-align:center;">
                                    <input class="btn btn-sm btn-primary" type="button" id="savePrintBtn"
                                        value="Save & Print">
                                </div>
                            </div>
                            <div class="col-4">
                                <div style="text-align:center;">
                                    <input class="btn btn-sm btn-primary" type="button" id="savePdfBtn"
                                        value="Save as Pdf">
                                </div>
                            </div>
                        </div> --}}
