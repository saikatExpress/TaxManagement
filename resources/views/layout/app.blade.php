...
<head>
    ...
    <link rel='shortcut icon' type='image/x-icon'
        href='{{ asset('custom/e7944c1b-36bd-4ee2-bdce-384d1b4b941d.jpg') }}' />
</head>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand">
                        <a href="{{ route('dashboard') }}"> <img style="width: 200px;" alt="image"
                                src="{{ asset('custom/e7944c1b-36bd-4ee2-bdce-384d1b4b941d.jpg') }}"
                                class="header-logo" />
                        </a>
                    </div>
